...
<i>Note: To find out which apps are currently available to use in the `-a` argument then just use `appcenter apps list` command (you need to be authenticated)</i>
